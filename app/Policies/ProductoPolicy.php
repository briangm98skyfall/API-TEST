...
class ProductoPolicy
{
    ...
    public function view(User $user, Producto $producto): Response
    {
        ...
        return $user->id === $user->id
            ? Response::allow()
            : Response::deny('Usted no tiene permisos para visualizar este producto');
    }
    ...
    public function update(User $user, Producto $producto): Response
    {
         ...
         return $user->id === $producto->producto_id
            ? Response::allow()
            : Response::deny('Usted no tiene permisos para actualizar este producto');
